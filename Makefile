...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"template","description":"A simple project template based on pyscaffold."}'
	test -f README.rst || echo "Template" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/template.git
